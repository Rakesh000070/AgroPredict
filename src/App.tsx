                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-4 pt-6 border-t border-brand-light mb-6">
                            <div className="text-center">
                              ...
                              <p className="text-sm font-bold text-emerald-600">{(prediction.confidence ?? 0).toFixed(1)}%</p>
                            </div>
                            <div className="text-center">
                              <p className="text-[11px] font-bold text-brand-navy/60 uppercase mb-1">Variance</p>
                              <p className="text-sm font-bold text-brand-blue">±{(prediction.variance ?? 0).toFixed(2)}</p>
                            </div>
                          </div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between items-end">
        ...
        <span className="text-xs font-black text-brand-teal">{value}{unit}</span>
      </div>
      <input 
        type="range" 
        min={min} 
